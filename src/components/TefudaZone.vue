<template>
    <div class="tefuda-zone-wrapper">
        <div class="tefuda-zone"
            :class="side"
        >
            <div class="open-tefuda"
                v-if="side === 'lower'"
            ...
            >
                ...
                >
                    ...
                    >
                        <div>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','battleCards', card)"
                            >f</span>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','shieldCards', card)"
                            >s</span>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','manaCards', card)"
                            >m</span>
                        </div>
                        <div>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','bochiCards', card)"
                            >b</span>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','yamafudaCards', card, true)"
                            >yt</span>
                            <span>|</span><span class="click"
                                v-on:click="moveCard('tefudaCards','yamafudaCards', card)"
                            >yb</span>
                        </div>
                        <!-- <div
                        ><span
